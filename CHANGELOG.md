...
### Fixed
- Surface sanitized workspace validation status in local-chat work reviews by collecting sandbox child state from hidden runtime files while excluding those files from diffs and promotion patches.
