...
class IsolatedInstallSmokeTest(unittest.TestCase):
    def test_install_doctor_sample_repo_and_deterministic_commands(self):
        with tempfile.TemporaryDirectory() as raw:
            ...
            self.assertEqual(workspace_payload["version"], "0.4.0-beta.6")
            ...
            self.assertEqual(readiness_payload["version"], "0.4.0-beta.6")
            ...
            self.assertEqual(release_payload["version"], "0.4.0-beta.6")
            ...
            self.assertEqual(release_pack_payload["version"], "0.4.0-beta.6")
            ...
            self.assertEqual(governance_payload["version"], "0.4.0-beta.6")
            ...
            self.assertEqual(alias_governance_payload["version"], "0.4.0-beta.6")
