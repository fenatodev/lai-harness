...
For beta cuts, use `lai readiness`, `lai release-check --target 0.4.0-beta.2 --json`, `make validate`, and the checks in [Beta readiness](BETA-READINESS.md). The beta gate is deterministic and does not tag, merge, push, upload, or publish artifacts.
