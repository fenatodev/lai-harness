...
lai project-handoff --target 0.4.0
lai project-handoff --target 0.4.0 --remote --json
lai project-handoff --target 0.4.0 --remote --out /tmp/lai-harness-project-handoff-v0.4.0 --force --json
...
lai project-handoff --target 0.4.0 --remote \
  --out /tmp/lai-harness-project-handoff-v0.4.0 --force --json
```
