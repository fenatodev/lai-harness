...
lai project-handoff --target 0.4.1
lai project-handoff --target 0.4.1 --remote --json
lai project-handoff --target 0.4.1 --remote --out /tmp/lai-harness-project-handoff-v0.4.1 --force --json
...
lai project-handoff --target 0.4.1 --remote \
  --out /tmp/lai-harness-project-handoff-v0.4.1 --force --json
```
