...
lai project-handoff --target 0.4.0-beta.17
lai project-handoff --target 0.4.0-beta.17 --remote --json
lai project-handoff --target 0.4.0-beta.17 --remote --out /tmp/lai-harness-project-handoff-v0.4.0-beta.17 --force --json
...
lai project-handoff --target 0.4.0-beta.17 --remote \
  --out /tmp/lai-harness-project-handoff-v0.4.0-beta.17 --force --json
```
