...
lai project-handoff --target 0.4.3
lai project-handoff --target 0.4.3 --remote --json
lai project-handoff --target 0.4.3 --remote --out /tmp/lai-harness-project-handoff-v0.4.3 --force --json
...
lai project-handoff --target 0.4.3 --remote \
  --out /tmp/lai-harness-project-handoff-v0.4.3 --force --json
```
