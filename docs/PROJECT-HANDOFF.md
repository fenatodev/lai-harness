...
lai project-handoff --target 0.4.0-beta.10
lai project-handoff --target 0.4.0-beta.10 --remote --json
lai project-handoff --target 0.4.0-beta.10 --remote --out /tmp/lai-harness-project-handoff-v0.4.0-beta.10 --force --json
...
lai project-handoff --target 0.4.0-beta.10 --remote \
  --out /tmp/lai-harness-project-handoff-v0.4.0-beta.10 --force --json
```
