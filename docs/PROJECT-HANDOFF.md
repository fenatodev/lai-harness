...
lai project-handoff --target 0.4.2
lai project-handoff --target 0.4.2 --remote --json
lai project-handoff --target 0.4.2 --remote --out /tmp/lai-harness-project-handoff-v0.4.2 --force --json
...
lai project-handoff --target 0.4.2 --remote \
  --out /tmp/lai-harness-project-handoff-v0.4.2 --force --json
```
