...
lai project-handoff --target 0.4.0-beta.22
lai project-handoff --target 0.4.0-beta.22 --remote --json
lai project-handoff --target 0.4.0-beta.22 --remote --out /tmp/lai-harness-project-handoff-v0.4.0-beta.22 --force --json
...
lai project-handoff --target 0.4.0-beta.22 --remote \
  --out /tmp/lai-harness-project-handoff-v0.4.0-beta.22 --force --json
```
