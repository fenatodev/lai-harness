...
lai project-handoff --target 0.4.0-beta.11
lai project-handoff --target 0.4.0-beta.11 --remote --json
lai project-handoff --target 0.4.0-beta.11 --remote --out /tmp/lai-harness-project-handoff-v0.4.0-beta.11 --force --json
...
lai project-handoff --target 0.4.0-beta.11 --remote \
  --out /tmp/lai-harness-project-handoff-v0.4.0-beta.11 --force --json
```
