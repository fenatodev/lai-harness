...
## lai harness v0.4.0-beta.2 — release polish
...
- Updated quick-start and release-check examples to target `0.4.0-beta.2`.
...
After pushing `main` and `v0.4.0-beta.2`, verify that GitHub Actions passes for both refs.

### Release body for GitHub

lai harness v0.4.0-beta.2 is a release-polish beta. It keeps the stabilized beta.1 agent behavior and improves the public release surface: current GitHub publishing metadata, ready-to-paste release notes, a manual release checklist, beta-targeted quick-start examples, and public `lai-harness-*` VSIX artifact naming.
